...
function tocarSom(som) {
    let audio = new Audio(soundsPath + som + '.wav');
    audio.play();
}
...
carregarSomAmbiente(soundsPath + 'arena_' + mapaSelecionado + '.wav');
...
const somVitoriaEl = new Audio(soundsPath + 'vitoria-som.mp3');
somVitoriaEl.preload = 'auto';
...
const somHooverOpcaoEl = new Audio(soundsPath + 'hoover-opcao.wav');
somHooverOpcaoEl.preload = 'auto';

const somCliqueOpcaoEl = new Audio(soundsPath + 'selecao-som.mp3');
somCliqueOpcaoEl.preload = 'auto';
