import { soundsPath } from './srcs.js';
...
const somOpcaoHooverEl = new Audio(soundsPath + 'hoover-opcao.wav');
somOpcaoHooverEl.preload = 'auto';

const somOpcaoAtivaEl = new Audio(soundsPath + 'selecao-som.mp3');
somOpcaoAtivaEl.preload = 'auto';

const somDesselecaoEl = new Audio(soundsPath + 'desselecao-som.wav');
somDesselecaoEl.preload = 'auto';

const somAlterarAcessorio = new Audio(soundsPath + 'somMudarRoupa.wav');
somAlterarAcessorio.preload = 'auto';

const somReadyEl = new Audio(soundsPath + 'somReady.wav');
somReadyEl.preload = 'auto';

const somVoltarEl = new Audio(soundsPath + 'somVoltar.ogg');
somVoltarEl.preload = 'auto';
...
function comecarJogo() { // função pra começar o jogo
    ...
    setTimeout(() => {
        window.location.href = '/mapSelection';
    }, 1000);
}
