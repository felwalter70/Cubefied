...
const somHooverMapEl = new Audio(soundsPath + 'somHooverMapa.wav');
somHooverMapEl.preload = 'auto';

const somCliqueMapaEl = new Audio(soundsPath + 'somCliqueMapa.wav');
somCliqueMapaEl.preload = 'auto';

let primeiroClique = 1;
let delaySomMapa;

function definirArena(evt) {
    if (primeiroClique) {
        delaySomMapa = 0;
        primeiroClique = 0;
    }
    ...
    setTimeout(() => {
        window.location.href = '/gameMatch';
    }, 1200);
}
